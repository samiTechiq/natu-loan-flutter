...
class SearchableStaffSelectionScreen extends StatefulWidget {
  final List<Staff> staffList;
  final Staff? selectedStaff;

  const SearchableStaffSelectionScreen({
    super.key,
  ...
  @override
  State<SearchableStaffSelectionScreen> createState() =>
      _SearchableStaffSelectionScreenState();
}

class _SearchableStaffSelectionScreenState
    extends State<SearchableStaffSelectionScreen> {
